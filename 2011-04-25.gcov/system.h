 ...
 * gcov-io.c:128: warning: implicit declaration of function 'fopen_unlocked'
 * gcov-io.c:128: warning: assignment makes pointer from integer without a cast
 */
FILE *fopen_unlocked (const char *, const char *);

/**
 * for the following warning
 * gcov-dump.c:85: warning: implicit declaration of function 'unlock_std_streams'
 */
void unlock_std_streams (void);

/**
 * for the following warnings
 * gcov.c:517: warning: implicit declaration of function 'xcalloc'
 * gcov.c:517: warning: assignment makes pointer from integer without a cast
 */
void *xcalloc (size_t nelem, size_t elsize);

/**
 * for the following warnings
 * gcov.c:624: warning: implicit declaration of function ¡®xmalloc¡¯
 * gcov.c:624: warning: assignment makes pointer from integer without a cast
 * gcov.c:634: warning: assignment makes pointer from integer without a cast
 * gcov.c:653: warning: assignment makes pointer from integer without a cast
 * gcov.c:657: warning: assignment makes pointer from integer without a cast
 */
void *xmalloc (size_t size);

/**
 * for the following warnings
 * gcov.c: In function ¡®find_source¡¯:
 * gcov.c:680: warning: implicit declaration of function ¡®xstrdup¡¯
 * gcov.c:680: warning: assignment makes pointer from integer without a cast
 * gcov.c: In function ¡®read_graph_file¡¯:
 * gcov.c:741: warning: assignment makes pointer from integer without a cast
 */
...
/**
 * zubo modified for the following error
 * In file included from errors.c:31:
 * system.h:193:24: error: safe-ctype.h: No such file or directory
 */
