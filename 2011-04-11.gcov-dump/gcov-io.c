...
gcov_read_summary (struct gcov_summary *summary)
{
    ...
    /***** that is, a summry is 40Bytes *****/
    for (csum = summary->ctrs, ix = GCOV_COUNTERS_SUMMABLE; ix--; csum++)
    {
        csum->num = gcov_read_unsigned ();  /***** 4Bytes *****/
        csum->runs = gcov_read_unsigned ();  /***** 4Bytes *****/
        csum->sum_all = gcov_read_counter ();  /***** read 8Bytes, but return 4Bytes *****/
        csum->run_max = gcov_read_counter ();  /***** read 8Bytes, but return 4Bytes *****/
        csum->sum_max = gcov_read_counter ();  /***** read 8Bytes, but return 4Bytes *****/
    }
